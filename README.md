...
1. [Administrative tasks](#1-administrative-tasks)
    ...
    iii. [Weekly timesheets, recaps, and emails](#iii-weekly-timesheets-recaps-and-emails)
    ...
    i. [Partner data requests](#vi-partner-data-requests)
    i. [Holidays and time off](#vii-holidays-and-time-off)
...
2. [Keeping files organized](#2-keeping-files-organized)
    ...
    i. [Working with Dropbox](#iii-working-with-dropbox)
    i. [Working with the Kellogg Linux Cluster (KLC) server](#iv-working-with-the-kellogg-linux-cluster-klc-server)
    ...
    i. [Keeping Github and Dropbox updated](#v-keeping-github-and-dropbox-updated)
...
3. [Coding best practices](#3-coding-best-practices)
    ...
    i. [Generating different presentation versions](#ii-generating-different-presentation-versions)
4. [Conducting Surveys](#4-conducting-surveys)
    i. [Pre-fieldwork](#i-pre-fieldwork)
        ...
        iii. [IRB](#iii-irb)
        i. [Piloting the survey](#iv-piloting-the-survey)
        i. [Hiring of field team](#v-hiring-of-field-team)
    i. [During fieldwork](#ii-during-fieldwork)
        i. [Data collection team composition](#vi-data-collection-team-composition)
        i. [Quality checks](#vii-quality-checks)
        i. [Documenting mistakes](#viii-documenting-mistakes)
        i. [High Frequency Checks (HFC)](#ix-high-frequency-checks-hfc)
            - [**Open-ended and multiple-choice with** ***other*** **option questions**](#open-ended-and-multiple-choice-with-other-option-questions)
        i. [Survey Report](#x-survey-report)
    i. [Post-fieldwork](#iii-post-fieldwork)
